...
export default function Home() {
  ...
  return <>
      ...
      <div className="studio-container">
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_1fr] lg:gap-12">
          ...
          <div className="hero-showcase">
            ...
            <Image src="/images/services/sites-web.webp" alt="Professionnels travaillant ensemble sur un site web" width={1200} height={800} preload className="hero-main-image" />
            ...
            <div className="showcase-mini"><Image src="/images/services/ia.webp" alt="Professionnels explorant des outils d’intelligence artificielle" width={1200} height={800} className="h-20 w-24 rounded-xl object-cover" /><div><span className="studio-kicker">La suite se construit</span><p className="mt-2 text-sm font-medium text-white">Web. Data. IA.</p></div></div>
          </div>
        </div>
    ...
    <section id="methode" className="studio-section scroll-mt-24"><div className="studio-container grid gap-12 lg:grid-cols-2 lg:items-center">
      <div className="method-art"><Image src="/images/services/consulting.webp" alt="Équipe réunie pour cadrer un projet" width={1200} height={800} className="aspect-[4/3] w-full rounded-3xl object-cover" /><div className="method-label"><Compass className="h-5 w-5 text-cyan-300" aria-hidden /><span>Une direction claire, à chaque étape.</span></div></div>
    ...
    <section className="studio-section studio-section-alt"><div className="studio-container"><div className="section-intro"><div><p className="studio-kicker">04 / Des usages, pas du jargon</p><h2 className="studio-heading mt-4">Le digital prend tout son sens<br />dans votre quotidien.</h2></div><Link href="/solutions" className="studio-link">Les solutions par secteur <ArrowUpRight className="h-4 w-4" aria-hidden /></Link></div><div className="grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
      <Link href="/portfolio" className="concept-feature group"><Image src="/images/services/plateformes.webp" alt="Professionnels utilisant une plateforme de travail" width={1200} height={800} className="aspect-[16/9] w-full object-cover transition duration-700 group-hover:scale-[1.02]" /><div className="p-6"><p className="studio-kicker">Concepts & cas d’usage</p><h3 className="mt-3 text-2xl font-semibold text-white">À quoi pourrait ressembler votre solution ?</h3><p className="mt-3 text-sm leading-7 text-slate-300">Explorez des scénarios de sites, de plateformes et d’assistants. Des exemples pour vous projeter.</p><span className="studio-link mt-5">Explorer les concepts <ArrowUpRight className="h-4 w-4" aria-hidden /></span></div></Link>
